"""
Django settings for djangoProjectPP4CI project.
...
SECRET_KEY = 'django-insecure-k#q5+2)$rxggt3*q^+x#xn17*cu8l6$la087rkc%2w1c$6obx8'
...
ROOT_URLCONF = 'djangoProjectPP4CI.urls'
...
WSGI_APPLICATION = 'djangoProjectPP4CI.wsgi.application'
...
#check this block going forward - unable to get image
STATIC_URL = '/static/'
...
JAZZMIN_SETTINGS = {
    ...
    'site_logo': "djangoProjectPP4CI/static/Masterworks logo higer quality.png",
